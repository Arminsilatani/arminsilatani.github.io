  ...
  constructor() {
    ...
    shadow.innerHTML = `
      ...
      <div class="footer-wrapper">
          ...
          <div class="footer-inner" id="footer-inner">
            ...
            <div class="column">
              ...
              <ul class="menu">
                ...
                <li><a href="/#/">Blog</a></li>
                <li><a href="https://tools.arminsilatani.com/" target="_blank" rel="noopener noreferrer">Strumenti</a></li>
                <li><a href="/it/sitemap/">Mappa del sito</a></li>
                <li><a href="/#/">Scarica il CV</a></li>
              </ul>
            </div>
        ...
        <div class="copyright">
          <p class="copyright-text">Tutti i diritti riservati.. ma non ho voglia di fare il vigile, per favore rispettateli voi.</p>
        </div>
      </div>
    `;
  }

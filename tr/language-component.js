...
class LanguageComponent extends HTMLElement {
  constructor() {
    ...
    style.textContent = `
            ...
            .language-dropdown {
                /* Fade settings for glass edge (you can change these values) */
                ...
                /* Shift menu to the right to negate padding, so texts align with 'فارسی |' */
                ...
                /* Create horizontal and vertical masks and combine them:
                   - First layer (horizontal): fades left and right
                   - Second layer (vertical): fades only bottom (top stays solid) */
                -webkit-mask-image:
                ...
                -webkit-mask-composite: source-in; /* Combine masks in Chrome and Safari */

                mask-image:
                    linear-gradient(to right, transparent 0%, black var(--fade-l), black calc(100% - var(--fade-r)), transparent 100%),
                    linear-gradient(to bottom, black 0%, black calc(100% - var(--fade-b)), transparent 100%);
                mask-composite: intersect; /* Combine masks in standard browsers */

                /* Create safe space with padding so link text doesn't enter the fade area and remains clear */
                padding-left: 10px;
                ...
                /* Ensure sufficient width to display text in the middle of the transparent area */
                min-width: 140px;
                overflow: hidden;
    ...
    langDisplay.textContent = "| Türkçe";

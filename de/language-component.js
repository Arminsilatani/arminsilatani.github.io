...
class LanguageComponent extends HTMLElement {
  constructor() {
    ...
    style.textContent = `
            ...
            .language-dropdown {
                /* Glass edge blur amount (you can change the values) */
                --fade-l: 65px;
                --fade-r: 30px;
                --fade-b: 30px;
                ...
                /* Shift menu to the right to compensate padding, so texts align with the language label */
                ...
                /*
                  ...
                  - Second layer (vertical): fades only bottom (top remains solid)
                */
                -webkit-mask-image:
                ...
                /* Create safe space with padding so link texts don't enter the blur region and remain clear */
                padding-left: 10px;
                ...
                /* Ensure sufficient width for texts to display in the middle of the transparent area */
                min-width: 140px;
                overflow: hidden;
    ...
    langDisplay.textContent = "| Deutsch";

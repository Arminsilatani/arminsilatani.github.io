    ...
    constructor() {
        ...
        style.textContent = `
            ...
            .language-dropdown {
                ...
                -webkit-mask-image: linear-gradient(to right, transparent 0%, black var(--fade-l), black calc(100% - var(--fade-r)), transparent 100%), linear-gradient(to bottom, black 0%, black calc(100% - var(--fade-b)), transparent 100%);
                -webkit-mask-composite: source-in;
                mask-image: linear-gradient(to right, transparent 0%, black var(--fade-l), black calc(100% - var(--fade-r)), transparent 100%), linear-gradient(to bottom, black 0%, black calc(100% - var(--fade-b)), transparent 100%);

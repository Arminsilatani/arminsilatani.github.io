...
class HeaderComponent extends HTMLElement {
  constructor() {
    ...
    style.textContent = `.container {
      ...
      .button:hover {
        box-shadow: 0 0 20px rgba(78, 205, 196, .8), 0 0 30px rgba(78, 205, 196, .8);
      }
    ...
    menu.innerHTML = `
      <a href="/arminsilatani.github.io/">صفحه اصلی</a>
      <a href="/services/">خدمات</a>
      <a href="/arminsilatani.github.io/about/">درباره من</a>
      <a href="/contact/">تماس با من</a>
      <a href="/arminsilatani.github.io/tariff/">تعرفه‌ها</a>
    ...
    links.forEach((link, i) => {
      link.addEventListener("mouseenter", () => {
        targets.fill(0);
        targets[i] = 1;
        if (targets[i - 1] != null) targets[i - 1] = 0.45;
        if (targets[i + 1] != null) targets[i + 1] = 0.45;

        const rect = link.getBoundingClientRect();
        const parent = menu.getBoundingClientRect();
        targetY = rect.top - parent.top + rect.height / 2;
      });
    });
